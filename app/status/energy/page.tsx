    ...
    switch (step) {
      ...
      case 4:
        return (
          <div className="flex flex-col gap-4 w-full">
            ...
            />
            <ChatBubble
              message="아무도 신경 쓰지 않아도 되는 시간이 온전히 필요하다"
      ...
      case 5:
        return (
          <div className="flex flex-col gap-4 w-full">
            <ChatBubble
              message="누군가와 함께 있을 땐 오히려 에너지가 빠지는 느낌이 든다"
      ...
      case 6:
        return (
          <div className="flex flex-col gap-4 w-full">
            <ChatBubble
              message="아침에 눈을 뜨자마자 머리가 맑고 집중이 잘 된다"
          ...
          <div className="w-full flex flex-col items-center justify-between h-full min-h-[calc(100vh-80px)]">
            ...
            <div className="w-full px-5">
              ...
              <div className="mt-4">
                <Button
                  activated={true}
                  onClick={() => router.push("/report/energy")}
                >
                  테스트 결과 보기
                </Button>
              </div>
